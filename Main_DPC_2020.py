...
# Define variables
main_path       = "/home/user3/Desktop/Maria Nadeem/Infinite-ISP/Defect Pixel Detection and Correction/DPC_dataset/Final Results (corr without 1)/"
...
for raw_path in paths:    
    ...
    out_img_path    = main_path +"openISP/corrected images/DPC_Output_openISP_imp_1th_70_nop0_no1_" + raw_filename +".png"
    out_mask_path   = main_path +"openISP/corrected masks/DPC_mask_openISP_imp_1th_70_nop0_no1_" + raw_filename +".raw"
...
result.save_csv(main_path, "openISP_imp_45_1th_70_no1_results")